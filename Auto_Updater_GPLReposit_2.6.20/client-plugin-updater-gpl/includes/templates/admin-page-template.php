...
?>
<div class="wrap" style="text-align: center; margin-top: 50px; background: linear-gradient(135deg, #9c27b0, #2196f3); color: #fff; padding: 30px; border-radius: 10px; border: 2px solid #9c27b0;">
    ...
    <form method="post" action="" style="margin: auto; max-width: 400px; background: rgba(255, 255, 255, 0.15); padding: 20px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.2); border: 1px solid rgba(156, 39, 176, 0.5);">
        ...
        <input type="text" name="api_key" id="api_key" value="<?php echo esc_attr($display_key); ?>" style="width: 100%; padding: 10px; border: 1px solid #9c27b0; border-radius: 5px; background: rgba(255, 255, 255, 0.9); color: #333;">
        ...
        <button type="submit" id="api_key_button" class="button-primary api-key-purple" style="margin-top: 20px; width: 100%; padding: 10px; font-size: 16px; border-radius: 5px; border-color: #9c27b0; color: #fff;">
...
jQuery(document).ready(function($) {
    ...
    function updateButton() {
        ...
        if (fieldValue === '') {
            ...
            apiKeyButton.removeClass('api-key-blue').addClass('api-key-purple');
        } else if (isActive && fieldValue === displayKey) {
            apiKeyButton.text('API Key Activada');
            apiKeyButton.removeClass('api-key-purple').addClass('api-key-blue');
        } else {
            apiKeyButton.text('Activar API Key');
            apiKeyButton.removeClass('api-key-blue').addClass('api-key-purple');
        }
