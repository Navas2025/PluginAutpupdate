...
?>
<div class="wrap" style="text-align: center; margin-top: 50px; background: linear-gradient(135deg, #ffb74d, #ff9800); color: #fff; padding: 30px; border-radius: 10px; border: 2px solid #ffb74d;">
    ...
    <form method="post" action="" style="margin: auto; max-width: 400px; background: rgba(255, 255, 255, 0.15); padding: 20px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.2); border: 1px solid rgba(255, 183, 77, 0.5);">
        ...
        <input type="text" name="api_key" id="api_key" value="<?php echo esc_attr($display_key); ?>" style="width: 100%; padding: 10px; border: 1px solid #ffb74d; border-radius: 5px; background: rgba(255, 255, 255, 0.9); color: #333;">
        ...
        <button type="submit" id="api_key_button" class="button-primary api-key-orange" style="margin-top: 20px; width: 100%; padding: 10px; font-size: 16px; border-radius: 5px; border-color: #ff9800; color: #fff;">
...
jQuery(document).ready(function($) {
    ...
    function updateButton() {
        ...
        if (fieldValue === '') {
            ...
            apiKeyButton.removeClass('api-key-green').addClass('api-key-orange');
        } else if (isActive && fieldValue === displayKey) {
            apiKeyButton.text('API Key Activada');
            apiKeyButton.removeClass('api-key-orange').addClass('api-key-green');
        } else {
            apiKeyButton.text('Activar API Key');
            apiKeyButton.removeClass('api-key-green').addClass('api-key-orange');
        }
